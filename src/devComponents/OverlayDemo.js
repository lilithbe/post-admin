...
const OverlayDemo = () => {
    ...
    const imageBodyTemplate = (data) => <img src={`https://lilithbe.github.io/post-admin/assets/demo/images/product/${data.image}`} alt={data.image} className="product-image" width="100" style={{ boxShadow: '0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23)' }} />;
