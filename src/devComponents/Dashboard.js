            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        <Column header="Image" body={(data) => <img className="shadow-2" src={`https://lilithbe.github.io/post-admin/assets/demo/images/product/${data.image}`} alt={data.image} width="50"/>}/>
