...
const MediaDemo = () => {
        ...
        return (
            <div className="product-item">
                <div className="product-item-content">
                    <div className="mb-3">
                        <img src={`https://lilithbe.github.io/post-admin/assets/demo/images/product/${product.image}`} alt={product.name} className="product-image" />
                    </div>
                    <div>
                        <h4 className="p-mb-1">
                            {product.name}
    ...
    const galleriaItemTemplate = (item) => <img src={`https://lilithbe.github.io/post-admin/assets/${item.itemImageSrc}`} alt={item.alt} style={{ width: '100%', display: 'block' }} />
    const galleriaThumbnailTemplate = (item) => <img src={`https://lilithbe.github.io/post-admin/assets/${item.thumbnailImageSrc}`} alt={item.alt} style={{ width: '100%', display: 'block' }} />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <div className="flex justify-content-center">
                        <Image src="https://lilithbe.github.io/assets/demo/images/galleria/galleria11.jpg" alt="galleria" width={250} preview />
                    </div>
                </div>
            </div>
        </div>
